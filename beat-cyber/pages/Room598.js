...
class NameForm extends React.Component {
  ...
  handleSubmit(event) {
    ...
    if(this.state.value=="Database error saving new user when using trigger") {
  ...
  render() {
    return (
      <div>
      <div STYLE="margin-bottom:2%;text-align:left">Le saviez-vous : l'injection de SQL est l'une des failles les plus communes sur les projets web étudiants</div>  
      <p></p>
      ...
      <label>
        ...
        {this.state.answered && <div STYLE="margin-bottom:5%; text-align:center; margin-left:23%"><a href="./Room631" STYLE="color:black">Question suivante</a></div>}
        </div></form></div>
    );
  }
}
