...
class NameForm extends React.Component {
  ...
  handleSubmit(event) {
    ...
    if(this.state.value=="auxiliary/scanner/sip/enumerator_tcp") {
  ...
  render() {
    return (
      <div>
      <div STYLE="margin-bottom:2%;text-align:left">Meilleur script sur Metasploit pour le port le plus intéressant</div>  
      <p></p>
      ...
      <label>
        ...
        {this.state.answered && <div STYLE="margin-bottom:5%; text-align:center; margin-left:23%"><a href="./Room344" STYLE="color:black">Question suivante</a></div>}
        </div></form></div>
    );
  }
}
