...
class NameForm extends React.Component {
  ...
  handleSubmit(event) {
    ...
    if(this.state.value.replace('flag2:/','').replace('/','')=="ALL ways you se in speck thor") {
  ...
  render() {
    return (
      <div>
      <div STYLE="margin-bottom:2%;text-align:left">Bannière hypertexte discrète</div>  
      <p></p>
      ...
      <label>
        ...
        {this.state.answered && <div STYLE="margin-bottom:5%; text-align:center; margin-left:23%"><a href="./Room598" STYLE="color:black">Question suivante</a></div>}
        </div></form></div>
    );
  }
}
