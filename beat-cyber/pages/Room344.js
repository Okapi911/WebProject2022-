...
class NameForm extends React.Component {
  ...
  handleSubmit(event) {
    ...
    if(this.state.value=="+1 123-456-7890") {
  ...
  render() {
    return (
      <div>
      <div STYLE="margin-bottom:2%;text-align:left">FlagPhone</div>  
      <p></p>
      ...
      <label>
        ...
        {this.state.answered && <div STYLE="margin-bottom:5%; text-align:center; margin-left:23%"><a href="./Room4112" STYLE="color:black">Question suivante</a></div>}
        </div></form></div>
    );
  }
}
